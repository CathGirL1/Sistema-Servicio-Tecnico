...
<%@ Page Title="Gestión de clientes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebCliente.aspx.cs" Inherits="Obligatorio_PR2.WebCliente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
      ...
      <asp:LinkButton ID="clickAgrCliente" runat="server" OnClick="clickAgregarCliente" CausesValidation="true" CssClass="botondelagregar">
      ...
      <asp:LinkButton ID="clickGrdCliente" runat="server" OnClick="clickGuardarCliente" CausesValidation="true" CssClass="botondelguardar">
    ...
    <asp:TextBox ID="txtBuscarCliente" runat="server"></asp:TextBox><asp:LinkButton ID="BotonBuscar" runat="server" OnClick ="ClickBuscarCliente" CausesValidation ="false" CssClass="botonBuscar">
        ...
        <asp:TemplateField>
            <ItemTemplate>
                <div class="GridViewButtonContainer">
                   ...
                   <asp:LinkButton ID="botonEditarCliente" runat="server" Text="Editar" ForeColor="Blue" 
                        CommandName="EditarCliente" CommandArgument='<%# Container.DataItemIndex %>' 
                        OnCommand="clickEditarCliente" CausesValidation="false" CssClass="botondeEditar">
