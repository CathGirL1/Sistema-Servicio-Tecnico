...
public class OrdenTrabajo
{
    ...
    public OrdenTrabajo(string pDescripcionProblema, string pCedulaCliente, string pCedulaTecnico)
    {
        // como hicimos en cliente y tecnico se incrementa el el numero de orden.                                                           
